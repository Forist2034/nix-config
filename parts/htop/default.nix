...
let
  mkConfig =
    ...
    ''
      ...
      column_meters_0=${cpu.left} PressureStallCPUSome Memory Zram HugePages Swap GPU PressureStallMemorySome PressureStallMemoryFull DiskIO NetworkIO
      column_meter_modes_0=1 2 1 1 1 1 1 2 2 2 2
